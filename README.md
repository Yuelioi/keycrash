...
快捷键突然没反应？KeyCrash 帮你检查组合键是否可用，并尝试找出占用它的软件。
...
3. 查看结果。如果显示被占用，点击 **定位占用软件**；找到后可打开它的文件位置。

按 **Esc** 可取消等待按键。右上角可以切换语言，点击 **?** 查看说明。

## 使用前了解

普通检测不会触发完整快捷键；**定位占用软件可能触发快捷键原本的操作**，必要时会请求管理员权限。部分系统保留快捷键或软件无法定位，未找到占用者不代表快捷键一定可用。
