...
- [x] 描边次操作只在键盘/辅助技术聚焦时显示焦点环；鼠标点击保持默认钢灰描边。
...
- [x] 将运行时状态、帮助、可访问性与错误文案收敛为可维护的三语语言包。
- [x] 在单窗口内提供中文、English、日本語切换，切换时保留当前检测状态。
- [x] 覆盖三种语言的核心文案测试，并通过格式、单测、Clippy 与 Release 构建。
